...
class sampleContainer:
    ...
    def loop( self ):
        ...
        if cut[3] > 0:
            ...
            self.h_Cuts.SetBinContent(4,0)
            self.h_Cuts.SetBinContent(5,0)
            #self.h_Cuts.SetBinContent(6,float(cut[2]/nent*100.))
            self.h_Cuts.SetBinContent(1,0)
            self.h_Cuts.SetBinContent(2,0)
            self.h_Cuts.SetBinContent(3,0)
            self.h_Cuts.SetBinContent(6,0)
            self.h_Cuts.SetBinContent(7,0)
            #self.h_Cuts.SetBinContent(9,float(cut[8]/nent*100.))
            #self.h_Cuts.SetBinContent(10,float(cut[9]/nent*100.))
            self.h_Cuts.SetBinContent(8,0)
