...
class sampleContainer:
	...
	'h_n_ak4T150'          :["h_"+self._name+"_n_ak4T150","; AK4 n_{T b-tags}, #DeltaR > 0.8, p_{T} > 150 GeV;", 10, 0, 10],
        ...
        'h_msd_ak8_topR2'      :["h_"+self._name+"_msd_ak8_topR2","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400],
        'h_msd_ak8_topR3'      :["h_"+self._name+"_msd_ak8_topR3","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400],
        'h_msd_ak8_topR4'      :["h_"+self._name+"_msd_ak8_topR4","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400],
        'h_msd_ak8_topR5'      :["h_"+self._name+"_msd_ak8_topR5","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400],
        'h_msd_ak8_topR6'      :["h_"+self._name+"_msd_ak8_topR6","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400],
        'h_msd_ak8_topR7'      :["h_"+self._name+"_msd_ak8_topR7","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400],
    ...
    def loop( self ):
		...
		self.h_n_ak4L150.Fill(    n_LPt150dR0p8_4, weight )
            ...
            if jpt_8 > 500  and jmsd_8 >40 and met < 180 and n_dR0p8_4 <5 and n_TdR0p8_4 < 3:
                self.h_msd_ak8_topR1.Fill( jmsd_8, weight )
            if jpt_8 > 500  and jmsd_8 >40 and met < 180 and n_dR0p8_4 <5 and n_TdR0p8_4 < 3 and  jdb_8 > 0.9 :
                self.h_msd_ak8_topR2.Fill( jmsd_8, weight )
            if jpt_8 > 500  and jmsd_8 >40 and met < 180 and n_dR0p8_4 <5 and n_TdR0p8_4 < 3 and  jdb_8 > 0.9  and jt21P_8 < 0.4:
                self.h_msd_ak8_topR3.Fill( jmsd_8, weight )                
            if jpt_8 > 500  and jmsd_8 >40  and  jdb_8 > 0.9  and jt21P_8 < 0.4 and jt32_8 > 0.7:
