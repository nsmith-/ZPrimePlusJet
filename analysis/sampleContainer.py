...
class sampleContainer:
    ...
    def __init__( self , fn, sf = 1, lumi = 1, isData = False, fillCA15=False, cutFormula='1'):
        ...
        # define histograms
        self.h_n_ak4              = ROOT.TH1F("h_n_ak4","; AK4 n_{jets}, p_{T} > 30 GeV;", 20, 0, 20)
        self.h_n_ak4_fwd          = ROOT.TH1F("h_n_ak4fwd","; AK4 n_{jets}, p_{T} > 100 GeV, 2.5<|#eta|<4.5;", 20, 0, 20)
        self.h_n_ak4L             = ROOT.TH1F("h_n_ak4L","; AK4 n_{L b-tags}, #DeltaR > 0.8, p_{T} > 40 GeV;", 20, 0, 20)
        self.h_n_ak4L100          = ROOT.TH1F("h_n_ak4L100","; AK4 n_{L b-tags}, #DeltaR > 0.8, p_{T} > 100 GeV;", 10, 0, 10)
        self.h_n_ak4M             = ROOT.TH1F("h_n_ak4M","; AK4 n_{M b-tags}, #DeltaR > 0.8, p_{T} > 40 GeV;", 20, 0, 20)
        self.h_n_ak4M100          = ROOT.TH1F("h_n_ak4M100","; AK4 n_{M b-tags}, #DeltaR > 0.8, p_{T} > 100 GeV;", 10, 0, 10)
        self.h_n_ak4T             = ROOT.TH1F("h_n_ak4T","; AK4 n_{T b-tags}, #DeltaR > 0.8, p_{T} > 40 GeV;", 20, 0, 20)
        self.h_n_ak4T100          = ROOT.TH1F("h_n_ak4T100","; AK4 n_{T b-tags}, #DeltaR > 0.8, p_{T} > 100 GeV;", 10, 0, 10)
        self.h_n_ak4_dR0p8        = ROOT.TH1F("h_n_ak4_dR0p8","; AK4 n_{jets}, #DeltaR > 0.8, p_{T} > 30 GeV;", 20, 0, 20)
        ...
        self.h_pt_ak8             = ROOT.TH1F("h_pt_ak8","; AK8 leading p_{T} [GeV];", 50, 300, 2100)
        self.h_pt_ak8_sub1         = ROOT.TH1F("h_pt_ak8_sub1","; AK8 subleading p_{T} [GeV];", 50, 300, 2100)
        self.h_pt_ak8_sub2         = ROOT.TH1F("h_pt_ak8_sub2","; AK8 3rd leading p_{T} [GeV];", 50, 300, 2100)
        self.h_pt_ak8_dbtagCut    = ROOT.TH1F("h_pt_ak8_dbtagCut","; AK8 leading p_{T} [GeV];", 45, 300, 2100)
        self.h_msd_ak8            = ROOT.TH1F("h_msd_ak8","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_msd_ak8_dbtagCut   = ROOT.TH1F("h_msd_ak8_dbtagCut","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_msd_ak8_t21ddtCut  = ROOT.TH1F("h_msd_ak8_t21ddtCut","; m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_msd_ak8_N2Cut      = ROOT.TH1F("h_msd_ak8_N2Cut","; m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_dbtag_ak8          = ROOT.TH1F("h_dbtag_ak8","; leading double b-tag;", 40, -1, 1)
        self.h_dbtag_ak8_sub1      = ROOT.TH1F("h_dbtag_ak8_sub1","; subleading double b-tag;", 40, -1, 1)
        self.h_dbtag_ak8_sub2      = ROOT.TH1F("h_dbtag_ak8_sub2","; 3rd leading double b-tag;", 40, -1, 1)
        ...
        self.h_msd_ak8_topR1      = ROOT.TH1F("h_msd_ak8_topR1","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_msd_ak8_topR2      = ROOT.TH1F("h_msd_ak8_topR2","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        ...
        self.h_msd_ak8_muCR1      = ROOT.TH1F("h_msd_ak8_muCR1","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_msd_ak8_muCR2      = ROOT.TH1F("h_msd_ak8_muCR2","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_msd_ak8_muCR3      = ROOT.TH1F("h_msd_ak8_muCR3","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_msd_ak8_muCR4      = ROOT.TH1F("h_msd_ak8_muCR4","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_msd_ak8_muCR5      = ROOT.TH1F("h_msd_ak8_muCR5","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        self.h_msd_ak8_muCR6      = ROOT.TH1F("h_msd_ak8_muCR6","; AK8 m_{SD}^{PUPPI} [GeV];", 24,40,400)
        ...
        self.h_n_ak4M.Sumw2()
        self.h_n_ak4T.Sumw2()       
        self.h_n_ak4L100.Sumw2()    
        self.h_n_ak4M100.Sumw2()       
        self.h_n_ak4T100.Sumw2()    
        self.h_isolationCA15.Sumw2()
        self.h_msd_ak8_topR1.Sumw2()
        self.h_msd_ak8_topR2.Sumw2()
        self.h_msd_ak8_topR3.Sumw2()
        self.h_msd_ak8_muCR1.Sumw2()
        self.h_msd_ak8_muCR2.Sumw2()
        self.h_msd_ak8_muCR3.Sumw2()
        self.h_msd_ak8_muCR4.Sumw2()
        self.h_msd_ak8_muCR5.Sumw2()
        self.h_msd_ak8_muCR6.Sumw2()
        ...
        self.h_met.Sumw2()
        self.h_pt_ak8_sub1.Sumw2()
        self.h_dbtag_ak8_sub1.Sumw2()        
        self.h_pt_ak8_sub2.Sumw2()
        self.h_dbtag_ak8_sub2.Sumw2()
    ...
    def loop( self ):
        ...
        for i in range(self._tt.GetEntries()):
            ...
            jpt_8_sub1  = self._tt.AK8Puppijet1_pt
            jpt_8_sub2  = self._tt.AK8Puppijet2_pt
            ...
            jdb_8_sub1 = self._tt.AK8CHSjet1_doublecsv
            jdb_8_sub2 = self._tt.AK8CHSjet2_doublecsv
            ...
            if self._tt.AK8Puppijet0_pt > 500 and self._tt.AK8Puppijet0_msd >40 and self._tt.nmuLoose>=1 and self._tt.neleLoose==0 and self._tt.nphoLoose==0 and self._tt.ntau==0 and self._tt.vmuoLoose0_pt>50 :
            ...
            if self._tt.AK8Puppijet0_pt > 500 and self._tt.AK8Puppijet0_msd >40: 
                ...
                self.h_n_ak4L100.Fill(    self._tt.nAK4PuppijetsLPt100dR08, weight )
                self.h_n_ak4M.Fill(    self._tt.nAK4PuppijetsMdR08    , weight )
                self.h_n_ak4M100.Fill(    self._tt.nAK4PuppijetsMPt100dR08, weight )
                self.h_n_ak4T.Fill(    self._tt.nAK4PuppijetsTdR08 , weight )
                self.h_n_ak4T100.Fill(    self._tt.nAK4PuppijetsTPt100dR08 , weight )
                self.h_isolationCA15.Fill(    self._tt.AK8Puppijet0_ratioCA15_04 , weight )
                self.h_met.Fill(self._tt.pfmet, weight)

            if self._tt.AK8Puppijet0_pt > 500 and jt21P_8 < 0.4 and self._tt.AK8Puppijet0_msd >40:
                self.h_msd_ak8_t21ddtCut.Fill( jmsd_8, weight )
	        self.h_t32_ak8_t21ddtCut.Fill( jt32_8, weight )

            if self._tt.AK8Puppijet0_pt > 500 and jtN2b1sdddt_8 < 0 and self._tt.AK8Puppijet0_msd >40:
                self.h_msd_ak8_N2Cut.Fill( jmsd_8, weight )

            if self._tt.AK8Puppijet0_pt > 500  and self._tt.AK8Puppijet0_msd >40 and self._tt.pfmet < 180 and self._tt.nAK4PuppijetsdR08 <5 and self._tt.nAK4PuppijetsTdR08 < 3:
                self.h_msd_ak8_topR1.Fill( jmsd_8, weight )
            if self._tt.AK8Puppijet0_pt > 500  and self._tt.AK8Puppijet0_msd >40 and self._tt.pfmet < 180 and self._tt.nAK4PuppijetsdR08 <5 and self._tt.nAK4PuppijetsTdR08 < 3 and  jdb_8 > 0.9 :
            ...
            if self._tt.AK8Puppijet0_pt > 500  and self._tt.AK8Puppijet0_msd >40 and self._tt.AK8Puppijet1_pt < 300 and self._tt.pfmet < 180 and self._tt.nAK4PuppijetsdR08 <5 and self._tt.nAK4PuppijetsTdR08 < 3 and  jdb_8 > 0.9  and jt21P_8 < 0.4:
