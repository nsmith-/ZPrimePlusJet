    ...
    def __init__(self, name, fn, sf=1, DBTAGCUTMIN=-99., lumi=1, isData=False, fillCA15=False, cutFormula='1', minBranches=False):
        ...
        if not self._minBranches:
            ...
            for dbcut in dbcuts:
                dbcutstring = str(dbcut).replace('0.','p')
                histos2d_ext.update({
                'h_msd_v_pt_topR6_%s_fail'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_matched'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_matched"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_unmatched'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_unmatched"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_JERUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_JERUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_JERDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_JERDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_JESUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_JESUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_JESDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_JESDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_triggerUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_triggerUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_triggerDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_triggerDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_PuUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_PuUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_fail_PuDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_fail_PuDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_matched'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_matched"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_unmatched'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_unmatched"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_JERUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_JERUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_JERDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_JERDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_JESUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_JESUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_JESDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_JESDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_triggerUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_triggerUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_triggerDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_triggerDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_PuUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_PuUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_%s_pass_PuDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_%s_pass_PuDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_matched'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_matched"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_unmatched'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_unmatched"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_JERUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_JERUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_JERDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_JERDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_JESUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_JESUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_JESDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_JESDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_triggerUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_triggerUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_triggerDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_triggerDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_PuUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_PuUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_fail_PuDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_fail_PuDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_matched'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_matched"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_unmatched'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_unmatched"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_JERUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_JERUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_JERDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_JERDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_JESUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_JESUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_JESDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_JESDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_triggerUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_triggerUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_triggerDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_triggerDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_PuUp'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_PuUp"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_topR6_N2_%s_pass_PuDown'%dbcutstring: ["h_" + self._name + "_msd_v_pt_topR6_N2_%s_pass_PuDown"%dbcutstring, "; " + self._jet_type + " m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"]
            })
