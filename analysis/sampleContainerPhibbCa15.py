    ...
    def __init__(self, name, fn, sf=1, DBTAGCUTMIN=-99., lumi=1, isData=False, fillCA15=False, cutFormula='1',
		...
		'h_rho_ca15_nocut': ["h_" + self._name + "_rho_ca15_nocut", "; p_{T}-leading  #rho=log(m_{SD}^{2}/p_{T}^{2}) ;", 42, -5, 0], 
        	...
        	'h_dbtag_ca15_aftercut': ["h_" + self._name + "_dbtag_ca15_aftercut", "; p_{T}-leading double-b tagger;", 33, -1, 1],
                ...
                'h_msd_ca15_topR6_p6_pass': ["h_" + self._name + "_msd_ca15_topR6_p6_pass", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
                'h_msd_ca15_topR6_p6_fail': ["h_" + self._name + "_msd_ca15_topR6_p6_fail", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
                'h_msd_ca15_topR6_p65_pass': ["h_" + self._name + "_msd_ca15_topR6_p65_pass", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
                'h_msd_ca15_topR6_p65_fail': ["h_" + self._name + "_msd_ca15_topR6_p65_fail", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
                ...
                'h_msd_ca15_topR6_p5_pass': ["h_" + self._name + "_msd_ca15_topR6_p5_pass", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
                'h_msd_ca15_topR6_p5_fail': ["h_" + self._name + "_msd_ca15_topR6_p5_fail", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
                'h_msd_ca15_topR6_p45_pass': ["h_" + self._name + "_msd_ca15_topR6_p45_pass", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
                'h_msd_ca15_topR6_p45_fail': ["h_" + self._name + "_msd_ca15_topR6_p45_fail", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
                'h_msd_ca15_topR6_p4_pass': ["h_" + self._name + "_msd_ca15_topR6_p4_pass", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
                'h_msd_ca15_topR6_p4_fail': ["h_" + self._name + "_msd_ca15_topR6_p4_fail", "; CA15 m_{SD}^{PUPPI} (GeV);", 80, 40, 600],
    ...
    def loop(self):
		...
		for i in range(0, len(ptscale)):
            ...
            if not self._minBranches:
                ...
                if jpt_15 > PTCUT and jmsd_15 > MASSCUT and rh_15<-0.8 and rh_15>-4.7:
            ...
            if jpt_15 > PTCUT and jmsd_15 > MASSCUT and met < METCUT and n_dR0p8_4 < NJETCUT and isTightVJet15 and jdb_15 > DBTAGCUT and rh_15<-0.8 and rh_15>-4.7:      
...
#            a_Cuts_ca15.SetBinLabel(7, "njet<5")
            ...
            a_Cuts_ca15.SetBinLabel(8, "-4.7<#rho<-0.8")
