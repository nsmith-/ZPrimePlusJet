...
def main(options,args,outputExists):
    ...
    tfiles = {'Hbb': [idir+'/GluGluHToBB_M125_13TeV_powheg_pythia8_0_1000pb_weighted.root',
		...
		#ZJetsToQQ_HT600toInf_13TeV_madgraph_1000pb_weighted.root'],#DYJetsToQQ_HT180_13TeV_1000pb_weighted.root '],
              ...
              'Phibb50': [idir+'/Spin0_ggPhi12j_g1_50_Scalar_13TeV_madgraph_0_1000pb_weighted.root'],
              'Phibb75': [idir+'/Spin0_ggPhi12j_g1_75_Scalar_13TeV_madgraph_0_1000pb_weighted.root'],
              ...
              'data': [idir+'JetHTRun2016B_23Sep2016_v1_0.root',
                       ...
                       idir+'JetHTRun2016C_23Sep2016_v1_0.root',
                       idir+'JetHTRun2016C_23Sep2016_v1_1.root',
                       ...
                       idir+'JetHTRun2016F_23Sep2016_v1_0.root',
                       idir+'JetHTRun2016F_23Sep2016_v1_1.root',
                       idir+'JetHTRun2016F_23Sep2016_v1_2.root',
                       idir+'JetHTRun2016F_23Sep2016_v1_3.root',
                       idir+'JetHTRun2016F_23Sep2016_v1_4.root',
                       idir+'JetHTRun2016G_23Sep2016_v1_0.root',
                       idir+'JetHTRun2016H_PromptReco_v1_0.root',
                       idir+'JetHTRun2016H_PromptReco_v2_0.root',
                       idir+'JetHTRun2016H_PromptReco_v2_1.root',
                       idir+'JetHTRun2016H_PromptReco_v2_2.root',
                       idir+'JetHTRun2016H_PromptReco_v2_3.root',
                       idir+'JetHTRun2016H_PromptReco_v2_4.root',
                       idir+'JetHTRun2016H_PromptReco_v2_5.root',
                       idir+'JetHTRun2016H_PromptReco_v2_6.root',
                       idir+'JetHTRun2016H_PromptReco_v2_7.root',
                       idir+'JetHTRun2016H_PromptReco_v3_0.root'],
              'muon': [idir+'SingleMuonRun2016B_23Sep2016_v1_0.root', 
                       idir+'SingleMuonRun2016B_23Sep2016_v3_0.root',
                       idir+'SingleMuonRun2016B_23Sep2016_v3_1.root',
                       idir+'SingleMuonRun2016C_23Sep2016_v1_0.root',
                       idir+'SingleMuonRun2016D_23Sep2016_v1_0.root',
                       idir+'SingleMuonRun2016E_23Sep2016_v1_0.root',
                       idir+'SingleMuonRun2016F_23Sep2016_v1_0.root',
                       idir+'SingleMuonRun2016G_23Sep2016_v1_0.root',
                       idir+'SingleMuonRun2016H_PromptReco_v1_0.root',
                       idir+'SingleMuonRun2016H_PromptReco_v2_0.root',
                       idir+'SingleMuonRun2016H_PromptReco_v3_0.root']
            }
