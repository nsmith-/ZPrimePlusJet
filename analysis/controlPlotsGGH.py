...
def main(options,args,outputExists):
    ...
    tfiles = {'Hbb':   [idir+'/GluGluHToBB_M125_13TeV_powheg_pythia8_all_1000pb_weighted.root',
	      ...
	      'ggHbb': [idir+'/GluGluHToBB_M125_13TeV_powheg_pythia8_all_1000pb_weighted.root'],
              ...
              'data': [idir+'JetHTRun2016B_03Feb2017_ver1_v1.root',
		       idir+'JetHTRun2016B_03Feb2017_ver2_v2.root',
		       idir+'JetHTRun2016C_03Feb2017_v1.root',
		       idir+'JetHTRun2016D_03Feb2017_v1.root',
		       idir+'JetHTRun2016E_03Feb2017_v1.root',
		       idir+'JetHTRun2016G_03Feb2017_v1_1.root',
		       idir+'JetHTRun2016F_03Feb2017_v1.root',
		       idir+'JetHTRun2016G_03Feb2017_v1_5.root',
		       idir+'JetHTRun2016G_03Feb2017_v1_2.root',
		       idir+'JetHTRun2016H_03Feb2017_ver2_v1.root',
		       idir+'JetHTRun2016H_03Feb2017_ver3_v1.root',
		       idir+'JetHTRun2016G_03Feb2017_v1_4.root',
		       idir+'JetHTRun2016G_03Feb2017_v1_3.root',
		       idir+'JetHTRun2016G_03Feb2017_v1_6.root',
		       idir+'JetHTRun2016G_03Feb2017_v1_0.root'],
    ...
    if isData and muonCR:
        ...
        plots = ['h_pt_ak8','h_msd_ak8','h_dbtag_ak8','h_n_ak4','h_n_ak4_dR0p8','h_t21_ak8','h_t32_ak8','h_n2b1sdddt_ak8','h_t21ddt_ak8','h_met','h_npv','h_eta_ak8','h_ht','h_dbtag_ak8_aftercut','h_n2b1sdddt_ak8_aftercut']
    else:
        plots = []
        testSample = sampleContainer('test',[], 1, DBTMIN,lumi)
        for attr in dir(testSample):
