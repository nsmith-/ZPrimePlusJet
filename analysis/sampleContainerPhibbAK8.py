    ...
    def __init__(self, name, fn, sf=1, DBTAGCUTMIN=-99., lumi=1, isData=False, fillCA15=False, cutFormula='1',
        ...
        if not self._minBranches:
            histos1d_ext = {
                ...
                'h_pt_ak8_dbtagCut': ["h_" + self._name + "_pt_ak8_dbtagCut", "; AK8 leading p_{T} (GeV);", 45, 300,
                                      2100],
                'h_msd_ak8': ["h_" + self._name + "_msd_ak8", "; p_{T}-leading m_{SD} (GeV);", 52, 40, 404],
                'h_msd_ak8_nocut': ["h_" + self._name + "_msd_ak8_nocut", "; p_{T}-leading m_{SD} (GeV);", 58, 0, 406],
                ...
                'h_msd_ak8_raw': ["h_" + self._name + "_msd_ak8_raw", "; AK8 m_{SD}^{PUPPI} no correction (GeV);", 52,
                                  40, 404],
                'h_msd_ak8_raw_nocut': ["h_" + self._name + "_msd_ak8_raw_nocut", "; AK8 m_{SD}^{PUPPI} no correction (GeV);", 58,
                                  0, 406],
		...
		'h_dbtag_ak8_aftercut': ["h_" + self._name + "_dbtag_ak8_aftercut", "; p_{T}-leading double-b tagger;", 33, -1, 1],
                ...
                'h_msd_ak8_bbleading_topR6_fail': ["h_" + self._name + "_msd_ak8_bbleading_topR6_fail",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p6_pass': ["h_" + self._name + "_msd_ak8_topR6_0p6_pass",
                                             "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p6_fail': ["h_" + self._name + "_msd_ak8_topR6_0p6_fail",
                                             "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p65_pass': ["h_" + self._name + "_msd_ak8_topR6_0p65_pass",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p65_fail': ["h_" + self._name + "_msd_ak8_topR6_0p65_fail",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p7_pass': ["h_" + self._name + "_msd_ak8_topR6_0p7_pass",
                                             "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p7_fail': ["h_" + self._name + "_msd_ak8_topR6_0p7_fail",
                                             "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p75_pass': ["h_" + self._name + "_msd_ak8_topR6_0p75_pass",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p75_fail': ["h_" + self._name + "_msd_ak8_topR6_0p75_fail",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p5_pass': ["h_" + self._name + "_msd_ak8_topR6_0p5_pass",
                                             "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p5_fail': ["h_" + self._name + "_msd_ak8_topR6_0p5_fail",
                                             "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p45_pass': ["h_" + self._name + "_msd_ak8_topR6_0p45_pass",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p45_fail': ["h_" + self._name + "_msd_ak8_topR6_0p45_fail",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p4_pass': ["h_" + self._name + "_msd_ak8_topR6_0p4_pass",
                                             "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p4_fail': ["h_" + self._name + "_msd_ak8_topR6_0p4_fail",
                                             "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p91_pass': ["h_" + self._name + "_msd_ak8_topR6_0p91_pass",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p91_fail': ["h_" + self._name + "_msd_ak8_topR6_0p91_fail",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p92_pass': ["h_" + self._name + "_msd_ak8_topR6_0p92_pass",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p92_fail': ["h_" + self._name + "_msd_ak8_topR6_0p92_fail",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p93_pass': ["h_" + self._name + "_msd_ak8_topR6_0p93_pass",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p93_fail': ["h_" + self._name + "_msd_ak8_topR6_0p93_fail",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p94_pass': ["h_" + self._name + "_msd_ak8_topR6_0p94_pass",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p94_fail': ["h_" + self._name + "_msd_ak8_topR6_0p94_fail",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p95_pass': ["h_" + self._name + "_msd_ak8_topR6_0p95_pass",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
                'h_msd_ak8_topR6_p95_fail': ["h_" + self._name + "_msd_ak8_topR6_0p95_fail",
                                              "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40, 201],
        ...
        if not self._minBranches:
            histos2d_ext = {
                ...
                'h_msd_v_pt_ak8_bbleading_muCR4_fail': ["h_" + self._name + "_msd_v_pt_ak8_bbleading_muCR4_fail",
                                                        "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p4_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p4_fail",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p4_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p4_pass",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p45_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p45_fail",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p45_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p45_pass",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p5_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p5_fail",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p5_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p5_pass",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p6_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p6_fail",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p6_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p6_pass",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p65_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p65_fail",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p65_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p65_pass",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_0p7_fail",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_fail_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_fail_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p7_pass_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p7_pass_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_fail_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_fail_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p75_pass_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p75_pass_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                ...
                'h_msd_v_pt_ak8_topR6_p8_fail_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_matched",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_fail_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_fail_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_fail_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_fail_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_fail_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_fail_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_fail_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_fail_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_fail_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_fail_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p8_pass_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p8_pass_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_fail_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_fail_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p85_pass_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p85_pass_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_fail_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_fail_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p9_pass_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p9_pass_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                ...
                'h_msd_v_pt_ak8_topR6_p95_fail': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_fail_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_fail_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass",
                                                   "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_matched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_matched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_unmatched': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_unmatched",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_JERUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_JERUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_JERDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_JERDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_JESUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_JESUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_JESDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_JESDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_triggerUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_triggerUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_triggerDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_triggerDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_PuUp': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_PuUp",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"],
                'h_msd_v_pt_ak8_topR6_p95_pass_PuDown': ["h_" + self._name + "_msd_v_pt_ak8_topR6_p95_pass_PuDown",
                                                  "; AK8 m_{SD}^{PUPPI} (GeV); AK8 p_{T} (GeV)"]
            }
