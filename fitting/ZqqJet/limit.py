...
def parser():
    parser = OptionParser()
    parser.add_option('--sig'    ,action='store',type='float',dest='sig'       ,default=0., help='mass')
    ...
    parser.add_option('--mass'    ,action='store',type='string',dest='mass'    ,default='50,75,100,125,150,200,250'  ,help='sig')
...
def biasgrid(base,alt,ntoys,mu,iLabel,iMass):
    ...
    sub_file.write('combine -M MaxLikelihoodFit --toysNoSystematics -t 1 --saveNLL --saveWithUncertainties --saveShapes --expectSignal %s --rMax 1.0 --rMin -1.0 --seed %i   %s  > /dev/null   \n' % (str(mu),rand,base))
...
def limit(base,iLabel,iMass):
    ...
    sub_file.write('cp -r %s . \n' % os.getcwd())
    sub_file.write('cd    %s   \n' % dirs[len(dirs)-1])
    #sub_file.write('combine -M Asymptotic %s \n' % base)
    #sub_file.write('combine -M MaxLikelihoodFit %s --saveShapes --saveWithUncertainties > /dev/null \n' % base)
    if int(iMass) < 150:
        #sub_file.write('combine -M ChannelCompatibilityCheck %s -m %s -g cat1 -g cat2 -g cat3 -g cat4 -g cat5 --saveFitResult --rMin -2 --rMax 2 --robustFit 1 > tmp.txt \n' %(base,iMass))
        #sub_file.write('combine Asymptotic %s -C 0.9 --rMin -2 --rMax 2 \n' % base)
        sub_file.write('combine -M Asymptotic %s \n' % base)
        ...
        #sub_file.write('combine -M ChannelCompatibilityCheck %s -m %s -g cat1 -g cat2 -g cat3 -g cat4 -g cat5 --saveFitResult --rMin -20 --rMax 20 --robustFit 1 > tmp.txt \n' %(base,iMass))
        #sub_file.write('combine -C 0.9 Asymptotic %s  --rMin -20 --rMax 20 --minimizerStrategy 0 \n' % base)
        sub_file.write('combine -M Asymptotic %s \n' % base
    ...
    #sub_file.write('mv higgsCombineTest.ChannelCompatibilityCheck.mH%s.root %s/%sChannelCompatibilityCheck.root \n' %(iMass,os.getcwd(),iLabel))
    #sub_file.write('mv tmp.txt %s/%scomptest.txt \n' %(os.getcwd(),iLabel))
...
def setup(iLabel,mass,iBase,condense):
    if not condense:
        ...
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_2345.txt > %s/card_rhalphabet_34_pt_2345.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_1345.txt > %s/card_rhalphabet_34_pt_1345.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_veffdecpt.txt > %s/card_rhalphabet_34_pt_veffdecpt.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_znorm.txt > %s/card_rhalphabet_34_pt_znorm.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale003dec.txt > %s/card_rhalphabet_34_pt_scale003dec.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale015dec.txt > %s/card_rhalphabet_34_pt_scale015dec.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_veffdecpt.txt > %s/card_rhalphabet_34_pt_veffdecpt.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale003.txt > %s/card_rhalphabet_34_pt_scale003.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale021.txt > %s/card_rhalphabet_34_pt_scale021.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale009.txt > %s/card_rhalphabet_34_pt_scale009.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale011.txt > %s/card_rhalphabet_34_pt_scale011.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale013.txt > %s/card_rhalphabet_34_pt_scale013.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale021sm.txt > %s/card_rhalphabet_34_pt_scale021sm.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale017.txt > %s/card_rhalphabet_34_pt_scale017.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale019.txt > %s/card_rhalphabet_34_pt_scale019.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_scale021.txt > %s/card_rhalphabet_34_pt_scale021.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt.txt > %s/card_rhalphabet_34_pt.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_1sig.txt > %s/card_rhalphabet_34_pt_1sig.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_2sig.txt > %s/card_rhalphabet_34_pt_2sig.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_3sig.txt > %s/card_rhalphabet_34_pt_3sig.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_4sig.txt > %s/card_rhalphabet_34_pt_4sig.txt' %(mass,iLabel))
        #os.system('sed "s@zqq100@zqq%s@g" card_rhalphabet_34_pt_5sig.txt > %s/card_rhalphabet_34_pt_5sig.txt' %(mass,iLabel))
        ...
        os.system('cp ralphabase_34_pt.root %s' % (iLabel))
    os.chdir (iLabel)
...
if __name__ == "__main__":
    ...
    for mass in options.mass.split(','):
        setup('ZQQ_'+str(mass),mass,"ralphabase_34_pt",options.condense)
        ...
        if not options.condense:
            for i0 in range(0,1):
                ...
                #biasgrid('card_rhalphabet_34_pt_scale001.txt','card_rhalphabet_34_pt_scale001.txt',options.toys,options.sig,'test_34_scale001_'+str(i0),mass,1)
                #biasgrid('card_rhalphabet_34_pt_scale003.txt','card_rhalphabet_34_pt_scale003.txt',options.toys,options.sig,'test_34_scale003_'+str(i0),mass,5)
                #biasgrid('card_rhalphabet_34_pt_scale005.txt','card_rhalphabet_34_pt_scale005.txt',options.toys,options.sig,'test_34_scale005_'+str(i0),mass,5)
                #biasgrid('card_rhalphabet_34_pt_scale007.txt','card_rhalphabet_34_pt_scale007.txt',options.toys,options.sig,'test_34_scale007_'+str(i0),mass,5)
                #biasgrid('card_rhalphabet_34_pt_scale009.txt','card_rhalphabet_34_pt_scale009.txt',options.toys,options.sig,'test_34_scale009_'+str(i0),mass,10)
                #biasgrid('card_rhalphabet_34_pt_scale011.txt','card_rhalphabet_34_pt_scale011.txt',options.toys,options.sig,'test_34_scale011_'+str(i0),mass,10)
                #biasgrid('card_rhalphabet_34_pt_scale013.txt','card_rhalphabet_34_pt_scale013.txt',options.toys,options.sig,'test_34_scale013_'+str(i0),mass,10)
                #biasgrid('card_rhalphabet_34_pt_scale015.txt','card_rhalphabet_34_pt_scale015.txt',options.toys,options.sig,'test_34_scale015_'+str(i0),mass,50)
                #biasgrid('card_rhalphabet_34_pt_scale017.txt','card_rhalphabet_34_pt_scale017.txt',options.toys,options.sig,'test_34_scale017_'+str(i0),mass,50)
                #biasgrid('card_rhalphabet_34_pt_scale019.txt','card_rhalphabet_34_pt_scale019.txt',options.toys,options.sig,'test_34_scale019_'+str(i0),mass,50)
                #biasgrid('card_rhalphabet_34_pt_scale021.txt','card_rhalphabet_34_pt_scale021.txt',options.toys,options.sig,'test_34_scale021_'+str(i0),mass,100)
                #for i0 in range(0,1):
                #biasgrid('card_rhalphabet_34_pt.txt','card_rhalphabet_34_pt.txt',options.toys,options.sig,'test_34_'+str(i0),mass)
                ...
                limit('card_rhalphabet_34_pt.txt','lim_34_results7',mass)
                #limit('card_rhalphabet_34_pt_1345.txt','lim_34_results71345',mass)
                #limit('card_rhalphabet_34_pt_2345.txt','lim_34_results72345',mass)
                #limit('card_rhalphabet_34_pt_veffdecpt.txt','lim_34_veffdecpt',mass)
                #limit('card_rhalphabet_34_pt_smear.txt','lim_34_smear',mass)
                #limit('card_rhalphabet_34_pt_znormdec_scale021.txt','lim_34_znormdec_scale021',mass)
                #limit('card_rhalphabet_34_pt_znormdec_scale003.txt','lim_34_znormdec_scale003',mass)
                #limit('card_rhalphabet_34_pt_scale003.txt','lim_34_scale003new',mass)
                #limit('card_rhalphabet_34_pt_scale021.txt','lim_34_scale021new',mass)
                #limit('card_rhalphabet_34_pt_veffdecpt.txt','lim_34_veffdecptnew',mass)
                #limit('card_rhalphabet_34_pt_scale007.txt','lim_34_scale007',mass)
                #limit('card_rhalphabet_34_pt_scale009.txt','lim_34_scale009',mass)
                #limit('card_rhalphabet_34_pt_scale011.txt','lim_34_scale011',mass)
                #limit('card_rhalphabet_34_pt_scale013.txt','lim_34_scale013',mass)
                #limit('card_rhalphabet_34_pt_scale015.txt','lim_34_scale015',mass)
                #limit('card_rhalphabet_34_pt_scale017.txt','lim_34_scale017',mass)
                #limit('card_rhalphabet_34_pt_scale019.txt','lim_34_scale019',mass)
                #limit('card_rhalphabet_34_pt_scale021.txt','lim_34_results7scale021',mass)
                #limit('card_rhalphabet_34_pt.txt','lim_34_nhan_200',mass)
                #limit('card_rhalphabet_34_pt_1sig.txt','lim_34_results7_1sig',mass)
                #limit('card_rhalphabet_34_pt_2sig.txt','lim_34_results7_2sig',mass)
                #limit('card_rhalphabet_34_pt_3sig.txt','lim_34_results7_3sig',mass)
                #limit('card_rhalphabet_34_pt_4sig.txt','lim_34_results7_4sig',mass)
                #limit('card_rhalphabet_34_pt_5sig.txt','lim_34_results7_5sig',mass)
        else:
            ...
            #biascondense('test_34_scale003_',options.sig,mass)
            #biascondense('test_34_scale005_',options.sig,mass)
            #biascondense('test_34_scale007_',options.sig,mass)
            #biascondense('test_34_scale009_',options.sig,mass)
            #biascondense('test_34_scale011_',options.sig,mass)
            #biascondense('test_34_scale013_',options.sig,mass)
            #biascondense('test_34_scale015_',options.sig,mass)
            #biascondense('test_34_scale017_',options.sig,mass)
            #biascondense('test_34_scale019_',options.sig,mass)
            #biascondense('test_34_scale021_',options.sig,mass)
