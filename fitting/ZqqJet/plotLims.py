...
def main():
	...
	#leg = ROOT.TLegend(0.20,0.65,0.4,0.85);
        leg = ROOT.TLegend(0.50,0.65,0.4,0.85);
	...
	hrl = can_mu.DrawFrame(lowlim,0,320,3);
        #hrl = can_mu.DrawFrame(lowlim,0,320,25);
	...
	ROOT.gPad.SetLogx();
	ROOT.gPad.SetLogy();
	gr_gB_2sigma.SaveAs('gq_2sigma_EXO17001.root')
        gr_gB_1sigma.SaveAs('gq_1sigma_EXO17001.root')
	gr_gB_exp.SaveAs('gq_exp_EXO17001.root')
	gr_gB_obs.SaveAs('gq_obs_EXO17001.root')
