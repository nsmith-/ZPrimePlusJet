...
class dazsleRhalphabetBuilder: 
	...
	def __init__( self, hpass, hfail, inputfile ): 
		...
		# rhomax= = -2, pt:500-600 40-184, pt:600-700 40-221, pt:700-800 40-258, pt:800-900 40-294, pt:900-1000 40-331
		# rhomax= = -2, pt:500-600 40-185,29, pt:600-700 40-220,36, pt:700-800 40-260,44, pt:800-900 40-295,51, pt:900-1000 40-330,58
		self._mass_nbins = 58;
		self._mass_lo    = 40;
		self._mass_hi    = 330;
		...
		self._lEffQCD = r.RooRealVar("qcdeff"    ,"qcdeff"    ,0.1 ,0.,5.0)
	...
	def makeRhalph(self,iHs,iHPs,iPt,iCat):
		...
		for i0 in range(1,self._mass_nbins+1):
			...
			if pSum < 4 and pSumP < 4:
                                pFail = r.RooRealVar(lName+"_fail_"+iCat+"_Bin"+str(i0),lName+"_fail_"+iCat+"_Bin"+str(i0),0,0.,0.1)
				pFail.setConstant(True)
				pPass = r.RooRealVar(lName+"_pass_"+iCat+"_Bin"+str(i0),lName+"_pass_"+iCat+"_Bin"+str(i0),0,0.,0.1)
