...
if __name__ == '__main__':
    ...
    script_group.add_option("--region" , dest="region", default='topR6_N2',choices=['topR6_N2','QGquark','QGgluon','Hcc1'], help="region for pass/fail doubleB tag", metavar="region")
    ...
    gitClone = "git clone -b HccAndrzej git://github.com/nsmith-/ZPrimePlusJet.git"
