...
parser = OptionParser()
parser.add_option('--input'  ,action='store',type='string',dest='input'    ,default='/afs/cern.ch/user/p/pharris/pharris/public/bacon/prod/CMSSW_7_1_20/src/VQQ/clean/1DPF/mlfit.root',help='input file')
parser.add_option('--data'   ,action='store',type='string',dest='data'     ,default='/afs/cern.ch/user/p/pharris/pharris/public/bacon/prod/CMSSW_7_1_20/src/VQQ/clean/1DPF/simple-shapes-RooDataHist.root',help='data file')
