...
if __name__ == "__main__":
    ...
    limit('card_1D_bern5.txt')
    ftest('card_1D_bern5.txt','card_1D_bern6.txt',options.toys,"ftest"+str(options.mass))
    goodness('card_1D_bern5.txt',options.toys,"goodness"+str(options.mass))
    bias('card_1D_bern5.txt','card_1D_bern6.txt',options.toys,options.sig,"fitbias"+str(options.mass))
    bias('card_1D_bern5.txt','card_1D_bern5.txt',options.toys,options.sig,"fitbase"+str(options.mass))
    plotmass('card_1D_bern5.txt',options.mass)
